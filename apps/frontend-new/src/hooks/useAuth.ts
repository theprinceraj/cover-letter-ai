...
import {
    AUTH_PROVIDERS,
    PASSWORD_TEST_REGEX,
    type AuthService_LoginGuest_Response,
    type AuthService_LoginLocal_Response,
    ...
    const login = useCallback(
        async (email: string, password: string) => {
            ...
            try {
                ...
                const { access_token } = response.data as AuthService_LoginLocal_Response;
                ...
                setAuthState((prev) => ({
                    ...
                    isEmailVerificationModalOpen:
                        userData.type !== AUTH_PROVIDERS.GUEST && userData.emailVerified === false,
                }));
            } catch (error) {
