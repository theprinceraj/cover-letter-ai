...
import { EMAIL_ADDRESS, FRONTEND_ENDPOINTS, LINKEDIN_URL, TWITTER_URL } from "../constants";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        <Link to={auth.user || auth.guest ? FRONTEND_ENDPOINTS.GENERATOR : FRONTEND_ENDPOINTS.LANDING}>
                            <h2 className="font-extrabold text-3xl md:text-4xl italic">
                                Cover<span className="text-primary underline underline-offset-4">Genius</span>
                            </h2>
                        </Link>
                        <p className="text-neutral-400 my-6">
                            Revolutionizing job applications with AI-powered cover letter generation.
                        </p>
                        ...
                        <FooterList title="Product">
                            {PRODUCT_LINKS.map((link) => (
                                <li key={link.href}>
                                    <a
                                        href={link.href}
                                        className="text-base text-neutral-400 hover:text-primary transition-colors focus:ring-2 focus:ring-primary rounded">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4 mt-4 md:mt-0">
                            <a
                                ...
                                className="lg:text-lg text-neutral-400 hover:text-primary transition-colors flex items-center focus:ring-2 focus:ring-primary rounded">
...
const FooterList: React.FC<PropsWithChildren<{ title: string }>> = ({ children, title }) => {
    return (
        <div>
