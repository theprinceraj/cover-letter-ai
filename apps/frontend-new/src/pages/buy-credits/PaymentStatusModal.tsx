...
export const PaymentStatusModal = memo(({ isOpen, onClose, isSuccess, onButtonClick }: PaymentStatusModalProps) => {
    ...
    return (
        <Modal
            ...
            <Button variant="yellow" size="md" onClick={onButtonClick}>
