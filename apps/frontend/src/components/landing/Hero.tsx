...
export const Hero: React.FC = () => {
    ...
    const handleCtaBtn = useCallback(() => {
        if (isAuthenticated) navigate(FRONTEND_ENDPOINTS.GENERATOR);
        else {
            openSignInModal();
            toast.info("Sign in to proceed");
        }
    }, [isAuthenticated, openSignInModal, navigate]);
        ...
        <HeroTemplate>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <DemoView
                    ...
                    handleFalseBtnClick={() => toast.info("This ain't no button buddy")}
                />
            </div>
        </HeroTemplate>
    );
...
const DemoView = ({
    ...
    return (
        <div className="relative mb-20">
            ...
            {/* Floating Elements */}
            <div
                className="absolute -bottom-4 -left-2 md:-left-4 bg-purple-500 text-white px-4 py-2 rounded-full text-sm font-medium shadow-medium animate-bounce delay-1000"
