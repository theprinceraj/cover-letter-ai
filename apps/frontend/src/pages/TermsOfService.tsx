          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  Analyzes job descriptions and resume content to generate
                  personalized cover letters
                </li>
                <li>
                  Provides enhancement suggestions for improving cover letters
                </li>
                <li>
                  Offers both registered user accounts and guest access options
                </li>
                <li>
                  Utilizes Google's Gemini AI technology for content generation
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  You may create an account by providing a valid email address and
                  password
                </li>
                <li>
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  Guest users can access the service without creating an account
                </li>
                <li>
                  Guest access is limited to {DEFAULT_USE_LIMIT_FOR_GUEST} cover
                  letter generation per IP address
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  ...
                  {DEFAULT_USE_LIMIT_FOR_REGISTERED_USER} cover letter generations
                  per account
                </li>
                <li>
                  <strong>Guest Users:</strong> Limited to{" "}
                  {DEFAULT_USE_LIMIT_FOR_GUEST} cover letter generation per IP
                  address
                </li>
                <li>
                  <strong>File Uploads:</strong> Only PDF files are accepted for
                  resume uploads
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  ...
                  and truthful information in your job descriptions and resumes
                </li>
                <li>
                  <strong>Content Ownership:</strong> You must own or have rights
                  to all content you upload, including resumes
                </li>
                <li>
                  <strong>Appropriate Use:</strong> You agree not to use the
                  service for any illegal, harmful, or inappropriate purposes
                </li>
                <li>
                  <strong>No Misrepresentation:</strong> You must not use
                  generated content to misrepresent your qualifications or
                  experience
                </li>
                <li>
                  <strong>Review and Edit:</strong> You are responsible for
                  reviewing, editing, and customizing generated cover letters
                  before use
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                ...
                <li>
                  Upload malicious software or attempt to compromise system
                  security
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-4">
                You retain ownership of content you upload (resumes, job
                descriptions, additional information). By using the Service, you
                grant us a limited license to process this content for the purpose
                of generating cover letters.
              </p>
              ...
              <p className="text-slate-300 mb-4">
                Cover letters generated by our AI system are provided for your use
                and customization. While we use AI technology, the final content
                and its use remain your responsibility.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-4">
                While we strive for quality, AI-generated content may contain
                errors or inaccuracies. You are responsible for reviewing and
                editing all generated content before use.
              </p>
              ...
              <p className="text-slate-300 mb-4">
                ...
                offers or successful applications. Job search success depends on
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-4">
                ...
                jurisdiction in which CoverGenius operates, without regard to its
