          ...
          <div className="prose prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-4">
                ...
                conditions for cancellations and refunds for CoverGenius
                services. By purchasing credits or using our services, you agree
                to these terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-slate-900 rounded-lg p-6 mb-4">
                ...
                <p className="text-slate-300 mb-4">
                  CoverGenius operates on a credit-based system with no
                  recurring subscriptions. Therefore, there are no subscriptions
                  to cancel.
                </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-4">
                Refunds are handled on a case-by-case basis and are subject to
                the following conditions:
              </p>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  <strong>No Partial Refunds:</strong> Once credits have been
                  used (even partially), no refunds will be provided for the
                  used portion
                </li>
                <li>
                  <strong>Unused Credits:</strong> Refunds may be considered for
                  completely unused credit packages
                </li>
                <li>
                  <strong>Technical Issues:</strong> Refunds may be provided for
                  technical issues that prevent service usage
                </li>
                <li>
                  <strong>Service Unavailability:</strong> Refunds may be
                  provided if our service becomes unavailable for extended
                  periods
                </li>
              </ul>
              ...
              <p className="text-slate-300 mb-4">
                To request a refund, you must contact us through the following
                channels:
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                ...
                <li>
                  <strong>Review Process:</strong> Each request is reviewed
                  individually based on the circumstances
                </li>
                <li>
                  <strong>Approved Refunds:</strong> If approved, refunds will
                  be processed within 5-10 business days
                </li>
                <li>
                  <strong>Payment Method:</strong> Refunds will be issued to the
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                <li>
                  <strong>Used Credits:</strong> Any credits that have been used
                  to generate cover letters
                </li>
                <li>
                  <strong>Change of Mind:</strong> Simply changing your mind
                  about the service after purchase
                </li>
                <li>
                  <strong>Account Violations:</strong> Accounts terminated due
                  to Terms of Service violations
                </li>
                <li>
                  <strong>Delayed Requests:</strong> Refund requests made more
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
                ...
                <li>
                  If you used a credit card, you may contact your bank about
                  chargeback options (though this should be a last resort)
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-4">
                ...
                posting on this page. Your continued use of our services after
