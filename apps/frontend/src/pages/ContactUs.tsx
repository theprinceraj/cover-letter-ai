        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="bg-slate-900 rounded-lg p-6 mb-8">
            ...
            <p className="text-slate-300 mb-4">
              Whether you have questions about our AI-powered cover letter
              generation service, need technical support, want to provide
              feedback, or have concerns about your account, we're here to assist
              you. We believe in providing excellent customer service and ensuring
              you have the best experience with CoverGenius.
            </p>
            <p className="text-slate-300">
              For the fastest response, we recommend reaching out via X (Twitter)
              direct message. You can also email us if you prefer a more detailed
              conversation or need to share attachments.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-slate-900 rounded-lg p-6 shadow">
              ...
              <p className="text-slate-300 text-sm mb-4">
                DM me on X for the fastest response! I'm usually available during
                business hours and try to respond to all messages within a few
                hours.
              </p>
              <a
            ...
            <div className="bg-slate-900 rounded-lg p-6 shadow">
              ...
              <p className="text-slate-300 text-sm mb-4">
                Perfect for longer conversations, sharing screenshots, or when you
                need to provide detailed information about your issue or request.
              </p>
              <a
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-medium text-white mb-3 flex items-center">
                  <HelpCircle size={20} className="mr-2 text-sky-400" />
                  Technical Support
                </h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-white mb-3 flex items-center">
                  <MessageCircle size={20} className="mr-2 text-sky-400" />
                  General Inquiries
                </h3>
                <ul className="text-slate-300 text-sm space-y-2">
          ...
          <div className="bg-slate-900 rounded-lg p-6 mb-8">
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center">
              <Clock size={20} className="mr-2 text-sky-400" />
              Response Times
            </h2>
          ...
          <div className="bg-slate-900 rounded-lg p-6">
            ...
            <p className="text-slate-300 mb-4">
              To help us assist you more efficiently, please have the following
              information ready:
            </p>
            ...
            <p className="text-slate-300 text-sm">
              ...
              experience. Thank you for choosing CoverGenius!
            </p>
          </div>
        </div>
      </div>
